...
if (empty($full_width) AND is_page_template( 'page-full-width.php')) {
	$output .= '<div class="container">';
}
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . '>';
if ($full_width == 'stretch_row' AND is_page_template( 'page-full-width.php')) {
	$output .= '<div class="container">';
}
